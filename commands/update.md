...
if [ -f "./.claude/get-shit-done/VERSION" ]; then
  ...
  echo "LOCAL"
elif [ -f /Users/alecgutman/.claude/get-shit-done/VERSION ]; then
  cat /Users/alecgutman/.claude/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/Users/alecgutman/.claude/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f /Users/alecgutman/.claude/cache/gsd-update-check.json
```
</step>
