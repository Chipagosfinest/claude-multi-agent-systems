...
@/Users/alecgutman/.claude/get-shit-done/references/git-integration.md
</required_reading>
...
See /Users/alecgutman/.claude/get-shit-done/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `/Users/alecgutman/.claude/get-shit-done/templates/user-setup.md`.
...
Use /Users/alecgutman/.claude/get-shit-done/templates/summary.md for structure.
